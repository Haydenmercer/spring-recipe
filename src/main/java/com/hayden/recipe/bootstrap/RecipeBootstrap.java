package com.hayden.recipe.bootstrap;

import com.hayden.recipe.domain.*;
import com.hayden.recipe.repositories.RecipeRepository;
import com.hayden.recipe.repositories.CategoryRepository;
import com.hayden.recipe.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private Category getCategory(String description) {
        return categoryRepository
                .findByCategoryName(description)
